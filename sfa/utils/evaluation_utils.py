...
def _topk(scores, K=40):
    ...
    #print(f'topk_scores size {topk_scores.size()}')
    #print(f'topk_inds size {topk_inds.size()}')
...
def convert_det_to_real_values(detections, num_classes=3, add_score=False): #ADD FOR AP
    kitti_dets = []
