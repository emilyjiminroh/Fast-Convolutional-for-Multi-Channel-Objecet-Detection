...
def save_checkpoint(checkpoints_dir, saved_fn, model_state_dict, utils_state_dict, epoch):
    ...
    model_save_path = os.path.join(checkpoints_dir, 'Model_{}_epoch_{}.pth'.format('classic', epoch))
    utils_save_path = os.path.join(checkpoints_dir, 'Utils_{}_epoch_{}.pth'.format('classic', epoch))
