...
import os
import argparse  # generate argument

import torch 
from easydict import EasyDict as edict # use value of dictionary as attribute ex. easy.val
...
def parse_train_configs():
    ...
    parser.add_argument('--saved_fn', type=str, default='SFA3D_Q_Version', metavar='FN',
    ...
    parser.add_argument('--mode', type=str, default='QRPN', #QRPN, 2x2_QRPN ClasicalFPN
                        help='the path of the pretrained checkpoint') 
    ...
    configs.down_ratio = 4   # S in paper
    ...
    configs.checkpoints_dir = os.path.join(configs.root_dir, 'checkpoints',configs.mode, configs.saved_fn)
